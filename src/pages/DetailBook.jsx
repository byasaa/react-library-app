...
class DetailBook extends Component {
  ...
  render() {
    ...
    let classStatus =
      this.state.book.status === "Available" ? "text-success" : "text-danger";
        ...
        <div style={cover}>
          <Navbar expand="md">
            ...
            {role === "admin" ? (
              <Nav className="ml-auto" navbar sty>
                <NavItem className="mr-3">
                  <Button outline color="warning" onClick={toggleEdit}>
                    Edit
                  </Button>
                </NavItem>
                <NavItem>
          ...
          <Container>
            <div
              ...
              style={{ position: "absolute", top: "410px" }}
            >
            ...
            <div>
              ...
              <p className={detailStyle.date}>
                {" "}
                {formatDate(this.state.book.created_at)}{" "}
              </p>
            </div>
            <div>
            ...
            <ModalEdit
              modalEditShow={this.state.showModalUpdate}
              toggle={toggleEdit}
              {...this.props}
            />
          </Container>
