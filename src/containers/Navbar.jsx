...
import { Navbar, Nav, Input, Button, Form } from "reactstrap";
      ...
      if (qs.sort || qs.orderBy) {
        props.history.push(
          props.location.search
            .replace(`orderBy=${qs.orderBy}`, `orderBy=${orderBy}`)
            .replace(`sort=${qs.sort}`, `sort=${sort}`)
        );
      } else {
        props.history.push(
          `${props.location.search}&orderBy=${orderBy}&sort=${sort}`
        );
      }
    }
  };
      ...
      >
        <Nav className="mr-auto" navbar>
          ...
          >
            ...
            <Button color="warning" onClick={() => filter()}>
              Filter
            </Button>
          </Form>
        </Nav>
