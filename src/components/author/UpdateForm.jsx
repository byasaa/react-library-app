...
class UpdateForm extends Component {
    ...
    handlePutUpdateAuthor = (e) => {
        ...
        this.props.dispatch(putUpdateAuthor(id, data, token))
        .then((res) => {
            Swal.fire(
    ...
    handleGetAuthorDetail = () => {
        const token = this.props.auth.data.token
        const id = this.props.match.params.id
        this.props.dispatch(getDetailAuthor(id, token))
        .then(() => {
            this.setState({
                            ...
                            <CardBody>
                                <Form onSubmit={this.handlePutUpdateAuthor}>
                                    <FormGroup>
                                        ...
                                        <Input type="text" name="name" id="name" placeholder="Input Author's Name" value={this.state.name} onChange={(e) => this.setState({ name : e.target.value })} />
                                    </FormGroup>
