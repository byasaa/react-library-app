...
class ModalEdit extends Component {
  ...
  getDetailBook = async () => {
    ...
    await this.props.dispatch(getDetailBook(id, token)).then(() => {
      this.setState({
        ...
        image:
          process.env.REACT_APP_API_URL + "img/" + this.props.book.data.image,
  ...
  render() {
    const { className, modalEditShow, toggle } = this.props;
    return (
      <>
